...
const string   ROBOT_POSE_FILENAME="validation_pose.xml";
    ...
    if(image_count==1)  //first time
        {
            ...
            fs<<"validation_pose"<<mat_pose_1_7;
            fs.release();
        }
    else
        {
...
int main(int argc, char** argv)
{
  ...
  ros::init(argc, argv, "get_validation_data_node");
  ros::start();
  Mat Jointstate;


   image_topic_name="/kinect2/hd/image_color";
//    image_topic_name="/camera/rgb/image_raw";
    robot_end_link="/arm_left_link_7_t";
